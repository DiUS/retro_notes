app.controller "ProjectsController", ['$scope', '$http', '$location', '$state', '$stateParams', 'Page', 'Project', 'ProjectRetro', ($scope, $http, $location, $state, $stateParams, Page, Project, ProjectRetro) ->
  # =========================================================================
  # Initialize
  # =========================================================================
